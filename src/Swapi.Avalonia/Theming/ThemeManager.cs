...
namespace Swapi.Avalonia.Theming;
...
public static class ThemeManager
{
    ...
    private static readonly Uri BaseUri = new("avares://Swapi.Avalonia/App.axaml");
    ...
    private static void Swap(string folder, string name)
    {
        ...
        {
            Source = new Uri($"avares://Swapi.Avalonia/{folder}/{name}.axaml"),
        });
    }
